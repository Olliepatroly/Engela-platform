...
insert into public.metric_readings (review_id, metric_code, current, previous, delta, status, history) values
  ...
  -- Goal is one activity a day (at least 6 a week) as of migration 0010.
  ('22222222-0000-4000-8000-000000000001', 'activity_sessions', 7, 6, 1, 'on_track',
   '[4,4,5,5,6,6,5,6,7,6,6,7]'::jsonb),
